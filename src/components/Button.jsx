export default function Button({ variant, type, click, children }) {
  if (variant === "primary") {
    return (
      <button
        className="bg-black pt-1 pb-1 pl-2 pr-2 rounded-lg text-white cursor-pointer min-w-[8rem]
    ...
    return (
      <button
        className="bg-taupe-400/60 dark:bg-mist-300/80 pt-1 pb-1 pl-2 pr-2 rounded-lg text-white cursor-pointer min-w-[8rem] text-black!
